...
<template>
  <!-- SEO Meta Tags -->
  <SEOHead
    title="Davxloper - Full Stack Developer & Designer"
    description="Portfolio of Davxloper - Full Stack Developer specializing in Vue.js, TypeScript, and modern web development. View my projects and get in touch."
    :keywords="[
      'web developer',
  ...
  >
    <div v-if="showContent" class="relative min-h-screen">
      ...
      <!-- Footer -->
      <footer
        class="py-8 bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800 transition-colors duration-300"
        role="contentinfo"
      >
        <div class="container-padding">
